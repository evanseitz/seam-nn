...
# =============================================================================
if save_figs or save_logos or save_data or load_previous_mave or load_previous_attributions or load_previous_linkage:
...
if view_logos is True:
    if sort_method is not None:
        ...
        ref_cluster = ref_index # TODO: check this
...
# Plot using MetaExplainer directly
print('\nMSM with TFBS positions enclosed:')
